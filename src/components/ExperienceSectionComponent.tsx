...
function ExperienceSectionComponent(): React.JSX.Element {
  return (
    ...
    >
      ...
      <SectionTitle title="Internship Experiences" />
      ...
      >
        ...
        <Flex
          ...
          rowGap={{ base: 3, lg: 5 }}
        >
          <SectionSubtitle>Internship Experiences⌛</SectionSubtitle>
          <SectionDescription>I have 1 year of internship experience where I played the role of Front End Developer, Data Analyst & Risk Analyst</SectionDescription>
        </Flex>
